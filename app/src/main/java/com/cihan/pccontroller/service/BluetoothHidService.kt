package com.cihan.pccontroller.service
...
import com.cihan.pccontroller.bluetooth.HidDeviceManager
import com.cihan.pccontroller.domain.HidCommand
import com.cihan.pccontroller.domain.PlatformStore
import com.cihan.pccontroller.domain.RemoteAction
import com.cihan.pccontroller.ui.MainActivity
...
class BluetoothHidService : LifecycleService() {
    ...
    companion object {
        ...
        private const val CHANNEL_ID = "pccontroller_hid_channel"

        const val ACTION_CONNECT = "com.cihan.pccontroller.CONNECT"
        const val ACTION_DISCONNECT = "com.cihan.pccontroller.DISCONNECT"
        const val ACTION_LEFT = "com.cihan.pccontroller.ACTION_LEFT"
        const val ACTION_RIGHT = "com.cihan.pccontroller.ACTION_RIGHT"
        const val ACTION_UP = "com.cihan.pccontroller.ACTION_UP"
        const val ACTION_DOWN = "com.cihan.pccontroller.ACTION_DOWN"
        const val ACTION_PLAY_PAUSE = "com.cihan.pccontroller.ACTION_PLAY_PAUSE"
        const val ACTION_VOL_UP = "com.cihan.pccontroller.ACTION_VOL_UP"
        const val ACTION_VOL_DOWN = "com.cihan.pccontroller.ACTION_VOL_DOWN"
    ...
    fun cancelConnect() = hidManager?.cancelConnect() ?: hidManager?.disconnect()
    ...
    fun mouseLeftClick() =
        hidManager?.sendMouseClick(com.cihan.pccontroller.bluetooth.HidReports.MOUSE_BTN_LEFT) ?: false

    fun mouseRightClick() =
        hidManager?.sendMouseClick(com.cihan.pccontroller.bluetooth.HidReports.MOUSE_BTN_RIGHT) ?: false

    fun mouseLeftDown() =
        hidManager?.sendMouseButtonDown(com.cihan.pccontroller.bluetooth.HidReports.MOUSE_BTN_LEFT) ?: false

    fun mouseLeftUp() =
        hidManager?.sendMouseButtonUp(com.cihan.pccontroller.bluetooth.HidReports.MOUSE_BTN_LEFT) ?: false

    fun mouseRightDown() =
        hidManager?.sendMouseButtonDown(com.cihan.pccontroller.bluetooth.HidReports.MOUSE_BTN_RIGHT) ?: false

    fun mouseRightUp() =
        hidManager?.sendMouseButtonUp(com.cihan.pccontroller.bluetooth.HidReports.MOUSE_BTN_RIGHT) ?: false
    ...
    override fun onCreate() {
        ...
        try {
            ...
            mediaSession = MediaSessionCompat(this, "PC Controller").apply {
    ...
    private fun buildNotification(state: ConnectionState): Notification {
        ...
        val text = when (state) {
            ...
            is ConnectionState.Idle -> getString(R.string.notification_idle)
        }

        val builder = NotificationCompat.Builder(this, CHANNEL_ID)
            .setContentTitle(title)
            .setContentText(text)
            .setSmallIcon(R.drawable.ic_stat_pccontroller)
        ...
        if (state is ConnectionState.Connected) {
            // Profil aksiyonları: Seek− | Ses− | Play | Ses+ | Seek+
            ...
            builder
                ...
                .addAction(
                    ...
                    getString(R.string.key_vol_down),
